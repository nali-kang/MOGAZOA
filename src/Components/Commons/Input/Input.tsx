...
const Input = React.forwardRef<HTMLInputElement | HTMLTextAreaElement, InputProps>(
  ({ className = '', invalid = false, textarea = false, formatter, ...rest }: InputProps, ref) => {
    ...
    const inputClasses = classNames(
      'flex leading-none p-[23px_20px] text-[14px] lg:text-[16px] text-white rounded-md border border-black4 outline-none bg-scblack placeholder-gray-400 resize-none',
